...
def index(self, i1=True, i2=True):
    """---------------------------------------------------------------------------------------------
    cretae an integer array version of the sequences.  this makes it easier to lookup scores.  i1
    and i2 indicate whether sequence 1 and sequence 2 should be indexed.
    ...
    if i1:
        self.i1 = []
        for letter in self.s1:
            self.i1.append(score.a2i(letter))
    if i2:
        self.i2 = []
        for letter in self.s2:
