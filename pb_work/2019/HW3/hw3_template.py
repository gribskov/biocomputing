...
you may create any additional functions you like; basecount is essentially the same as composition
in HW2.  Truncate is essentially the same as trim_by_quality. To make your life easier,
I have provided some portions of the function code
...
def basecount(fq_entry, count, threshold=0):
    ...
    # add your code here.  count should be adictionary with the bases as the keys
    # the total number of bases is stored with the key 'total'
