...
;--------------------------------------------------------------------------------
; click mouse button to change color of cells, clicking changes red patches to
; black, and any other color to red
; this basically emulates a on-mouse-up function used in other languages
;--------------------------------------------------------------------------------
to edit-cells
  ifelse mouse-down? [
...
;--------------------------------------------------------------------------------
; add one to the count (nbors) of each red patch
;--------------------------------------------------------------------------------
to count-neighbors
  ask patches with [ pcolor = red ][
    ask neighbors [ set nbors nbors + 1 ]
  ]
end
